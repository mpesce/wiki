...
## [2026-08-26] tool | ingest_wiki.py: fixed slug-collision bug — same-named re-uploads and different names that slugify to the same base (case/resolution/speaker variants) were silently dropping 14 recordings. Now: first occurrence owns the base slug, Nth gets "<base>-N"; identical-content re-uploads are folded into the owner page. Also fixed datetime.utcnow() deprecation.
## [2026-08-26] compile | 34 entity + 51 concept pages rebuilt from full manifest
...
## [2026-08-26] update | INDEX.md regenerated (3 people, 17 orgs, 14 technologies, 51 concepts, 625 sources); LOG.md restored to proper timeline format (had been overwritten with a lint report); overview.md + WIKI.md §10 updated
