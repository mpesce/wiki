...
## TL;DR
<7 sources reference the Metaverse. Compile the one-line synthesis from the sources below.>

## Overview
<Compile a cross-source synthesis of the Metaverse. What is consistent and what changed over time.>
