...
## TL;DR
<27 sources reference The Next Billion Seconds. Compile the one-line synthesis from the sources below.>

## Overview
<Compile a cross-source synthesis of The Next Billion Seconds. What is consistent and what changed over time.>
