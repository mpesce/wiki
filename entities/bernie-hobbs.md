...
## TL;DR
<31 sources reference Bernie Hobbs. Compile the one-line synthesis from the sources below.>

## Overview
<Compile a cross-source synthesis of Bernie Hobbs. What is consistent and what changed over time.>
