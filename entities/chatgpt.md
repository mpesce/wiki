...
## TL;DR
<6 sources reference ChatGPT. Compile the one-line synthesis from the sources below.>

## Overview
<Compile a cross-source synthesis of ChatGPT. What is consistent and what changed over time.>
