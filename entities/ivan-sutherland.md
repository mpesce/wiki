...
## TL;DR
<13 sources reference Ivan Sutherland. Compile the one-line synthesis from the sources below.>

## Overview
<Compile a cross-source synthesis of Ivan Sutherland. What is consistent and what changed over time.>
