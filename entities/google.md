...
From 2017 the tone shifts toward monopoly and surveillance concerns. Pesce warns that Android phones send location data to Google by default ([[sources/lms-20170505-0906-families-privacy-mp3]]) and, in the Luther-anniversary keynote, names Google's Project Tango AR (like the iPhone X's TrueDepth camera) as an inherently locative, facial-tracking technology of surveillance ([[sources/last-days-of-reality-toronto-17oct17-mov]]). The 2019 interviews sharpen this into data governance: Google holds the full, non-anonymized medical records of ~50 million US patients via Ascension with no clear consumer product to justify it, and the Fitbit acquisition hands Google continuous biometric data to feed AI models — raising antitrust-style questions about private control of health data ([[sources/ntn-20191114-1105-should-we-really-trust-big-tec]]). During COVID he covers the Apple–Google exposure-notification framework and its stringent security rules ([[sources/ntn-20200521-1105-do-track-and-trace-apps-work-t]]) and warns that the pandemic has deepened the data-mining profiles held by Facebook, TikTok and Google ([[sources/good-shout-29may20-m4v]]).

Google also threads through Pesce's VR/AR historiography and platform geography. He credits 2014's Google Cardboard with democratizing VR by turning smartphones into headsets ([[sources/arin6904-5sep18-mp3]], [[sources/reality-remix-wav]]), maps AR spectacles from Apple, Google and Facebook as imminent consumer staples ([[sources/accanet-12sep18-mp3]], [[sources/supertools-aut-9may19-mp3]]), and, in the surveillance-status lecture, traces Google Maps back to the 2004 Keyhole acquisition — arguing Maps presents a filtered version of the world designed to direct user behavior rather than an objective view ([[sources/surveillance-status-arin2610-20oct20-mp4]]). His 2021 AR lectures cast Google among the companies asserting the "right to write" digital content into physical space without consent ([[sources/arin-2610-internet-transformations-the-ar-dilemm]]). Elsewhere Google is simply infrastructure — Project Loon in a PNG connectivity talk ([[sources/png2019-mkv]]) — and the corpus does not document Pesce's own tenure at Google; the Mozilla-era employment he cites is with Mozilla, not Google.
