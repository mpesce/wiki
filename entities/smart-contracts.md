...
## TL;DR
<7 sources reference smart contracts. Compile the one-line synthesis from the sources below.>

## Overview
<Compile a cross-source synthesis of smart contracts. What is consistent and what changed over time.>
