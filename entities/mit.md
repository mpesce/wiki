...
## TL;DR
<10 sources reference MIT. Compile the one-line synthesis from the sources below.>

## Overview
<Compile a cross-source synthesis of MIT. What is consistent and what changed over time.>
