...
## TL;DR
<8 sources reference Terence McKenna. Compile the one-line synthesis from the sources below.>

## Overview
<Compile a cross-source synthesis of Terence McKenna. What is consistent and what changed over time.>
