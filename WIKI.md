...
- Dates normalized 2026-08-27 (`tools/normalize_dates.py`): 176 sources
  ...
  289/625 dated (1989-2025), 336 unknown.
- Entity pages: 61 (17 people, 25 orgs, 19 technologies) — vocabulary
  expanded 2026-08-27 with ASR-variant matching (`ingest_wiki.py`
  MATCH_VARIANTS); ORG/TECH extractors now match labels as well as slugs.
- Concept pages: 50. Query pages: 10 (seeded 2026-08-27).
- 16 entity/concept pages carry synthesized TL;DR/Overview prose
  (preserved across recompiles by `compile_wiki.py`).
